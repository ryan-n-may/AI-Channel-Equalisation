...
for i = 1:1:REPEAT_DENOISING_RUNS
    ...
    CHANNEL_H   = CHANNEL_H_SPLIT;
    IFFT_Y      = [real(IFFT_PREDICTION_COMPLEX) ; imag(IFFT_PREDICTION_COMPLEX)];
    IFFT_X      = IFFT_X_SPLIT;

    %% Appending outputs 
    LSTM_INPUT_APPENDED     = [LSTM_INPUT_APPENDED LSTM_INPUT];
    CHANNEL_H_APPENDED      = [CHANNEL_H_APPENDED CHANNEL_H];
    IFFT_Y_APPENDED         = [IFFT_Y_APPENDED IFFT_Y];
    IFFT_X_APPENDED         = [IFFT_X_APPENDED IFFT_X];
end 

LSTM_INPUT = LSTM_INPUT_APPENDED;
CHANNEL_H = CHANNEL_H_APPENDED;
IFFT_X = IFFT_X_APPENDED;
